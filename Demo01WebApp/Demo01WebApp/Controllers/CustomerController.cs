...
namespace Demo01WebApp.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public CustomerController(Bank context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerID,FirstName,LastName,Email,Password,CreatedAt")] Customer customer)
        {
