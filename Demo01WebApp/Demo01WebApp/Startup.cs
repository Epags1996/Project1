...
namespace Demo01WebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TestDBDbContext>(options =>
                options.UseSqlServer(
                    Configuration.GetConnectionString("TestDBDbContext")));

            services.AddDbContext<Bank>(options => options.UseSqlServer(Configuration.GetConnectionString("TestDBDbContext")));
